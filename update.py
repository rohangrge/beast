...
class Application:
    def __init__(self, master):
        ...
        # search button
        self.search = Button(master, text="Search", width=12, height=1, bg='blue', command=self.search_db)
    ...
    def update_db(self):
        ...
        conn.commit()
        tkinter.messagebox.showinfo("Updated", "Your changes have been successfully updated.")
    def delete_db(self):
